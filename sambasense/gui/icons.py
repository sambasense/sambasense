...
def icon_coffee(color: str = "#FFD700", size: int = 24) -> QIcon:
    svg = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="{size}" height="{size}">
      <path d="M18 8h1a4 4 0 0 1 0 8h-1" stroke="{color}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
      <path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z" stroke="{color}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="{color}" fill-opacity="0.15"/>
      <line x1="6" y1="1" x2="6" y2="4" stroke="{color}" stroke-width="1.5" stroke-linecap="round"/>
      <line x1="10" y1="1" x2="10" y2="4" stroke="{color}" stroke-width="1.5" stroke-linecap="round"/>
      <line x1="14" y1="1" x2="14" y2="4" stroke="{color}" stroke-width="1.5" stroke-linecap="round"/>
    </svg>'''
    return _icon_from_svg(svg, size)
